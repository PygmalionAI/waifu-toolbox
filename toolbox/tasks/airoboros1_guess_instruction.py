...
class Airoboros1GuessInstructionTask(BaseTask):
    '''Instruction guessing task based on the Airoboros 1.4.1 dataset.'''
    def __init__(
        self,
    ...
    def __iter__(self) -> Generator[Episode, None, None]:
        LOG.info("Processing data for task Airoboros1InstructionFollowingTask.")
        for idx, example in enumerate(Airoboros1Dataset()):
            ...
            episode = Episode(turns=turns, identifier=f"airoboros1-gti-{idx}")
